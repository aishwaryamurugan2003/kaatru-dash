    ...
    <header className="sticky top-0 bg-white dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 z-20">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Header: Left side - Hamburger & Title */}
          ...
          <div className="flex items-center">
             <div className="relative" ref={profileRef}>
                ...
                {isProfileOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5 focus:outline-none origin-top-right transform transition-all duration-200 z-50">
                        <a
                            href="#"
